...
'#Region "Windows Form Designer generated code"
        ...
        Private Sub InitializeComponent()
            ...
            Me.label1.Text = "Perform a sales analysis using the XL Export API." & Global.Microsoft.VisualBasic.Constants.vbCrLf & "Click one of the buttons below" & " to save the document " & Global.Microsoft.VisualBasic.Constants.vbCrLf & "in the corresponding format."
            ' 
            ' btnExportToXLS
            ' 
